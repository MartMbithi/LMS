                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_ins_manage_units.php">Units</a>
                                    </li>
                                    ...
                                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge badge-success" href="pages_ins_manage_single_course_units.php?cc_id=<?php echo $row->cc_id;?>">
