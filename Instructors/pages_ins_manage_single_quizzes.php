            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        $c_id = $_GET['c_id'];
                        $ret = "SELECT  * FROM  lms_units_assaigns WHERE c_id = ?";
                            ...
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="pages_ins_manage_testquizzes.php">Questions</a>
                                        </li>
                                        <li class="breadcrumb-item"><a href="pages_ins_manage_testquizzes.php">Manage</a>
                                        </li>
                                        <li class="breadcrumb-item"><a href="pages_ins_manage_testquizzes.php"><?php echo $row->c_name; ?> Questions.</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_ins_update_specific_quizzes.php?q_id=<?php echo $row->q_id; ?>">
                                                            <i class="fas fa-edit"></i> <i class="icon  icon-doc "></i> Update Quizzes
                                                        </a>

                                                        <a class="badge badge-danger" href="pages_ins_manage_single_quizzes.php?delete=<?php echo $row->q_id; ?>&c_id=<?php echo $row->c_id; ?>">
