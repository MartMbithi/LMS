                                ...
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $cc_id = $_GET['cc_id'];
                                            $i_id = $_SESSION['i_id'];
                                            $ret = "SELECT  * FROM  lms_course WHERE cc_id = ? AND i_id = ?";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->bind_param('ii', $cc_id, $i_id);
                                            $stmt->execute(); //ok
                                            $res = $stmt->get_result();
                                            $cnt = 1;
                                            while ($row = $res->fetch_object()) {
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_ins_view_single_unit.php?c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>">
                                                            <i class="fas fa-eye"></i> <i class=" fas fa-calendar-alt"></i>View
                                                        </a>
                                                        <a class="badge badge-warning" href="pages_ins_update_single_unit.php?c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>">
                                                            <i class="fas fa-edit"></i> <i class=" fas fa-calendar-alt"></i>Update
                                                        </a>
                                                        <a class="badge badge-danger" href="pages_ins_manage_courses.php?delete_id=<?php echo $row->c_id; ?>">
