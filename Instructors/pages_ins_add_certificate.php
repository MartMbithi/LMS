                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_ins_add_certificate.php">Add</a>
                                    </li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_ins_add_single_certificate.php?en_id=<?php echo $row->en_id; ?>&s_id=<?php echo $row->s_id; ?>&i_id=<?php echo $row->i_id; ?>&en_date=<?php echo date("d M Y", strtotime($mysqlDateTime)); ?>">
                                                            <i class="icon   icon-trophy  "></i> <i class=" fas fa-pallet"></i>
                                                            Add Certificate
                                                        </a>
                                                    </td>
                                                </tr>
