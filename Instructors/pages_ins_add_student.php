                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_ins_add_student.php">Register</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <form method ="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">    
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="custom-select" id="inputGroupSelect03" required name="s_gender" aria-label="Example select with button addon">
                                                <option selected>Choose...</option>
