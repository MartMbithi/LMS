                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_admin_view_enrollments.php">View</a>
                                    </li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_ins_view_single_enrollment.php?en_id=<?php echo $row->en_id; ?>&cc_id=<?php echo $row->cc_id; ?>&c_id=<?php echo $row->c_id; ?>&i_id=<?php echo $row->i_id; ?>&s_id=<?php echo $row->s_id; ?>">
