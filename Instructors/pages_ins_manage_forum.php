                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_ins_view_forum.php?f_id=<?php echo $row->f_id; ?>&i_id=<?php echo $row->i_id; ?>&c_id=<?php echo $row->c_id; ?>&s_unit_code=<?php echo $row->s_unit_code; ?>&s_unit_name=<?php echo $row->s_unit_name; ?>&f_no=<?php echo $row->f_no; ?>">
                                                            <i class="fa fa-eye"></i> <i class=" icon icon-envelope-open"></i>
                                                            View Discussion
                                                        </a>
                                                        <a class="badge badge-warning" href="pages_ins_update_forum.php?f_id=<?php echo $row->f_id; ?>">
                                                            <i class="far fa-edit"></i> <i class=" icon icon-envelope-open"></i>
                                                            Update Discussion
                                                        </a>
                                                        <a class="badge badge-danger" href="pages_ins_manage_forum.php?delete=<?php echo $row->f_id; ?>">
