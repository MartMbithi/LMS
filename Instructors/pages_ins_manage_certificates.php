                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_ins_generate_certificate.php?cert_id=<?php echo $row->cert_id; ?>">
                                                            <i class=" fas fa-check"></i> <i class="  fas fa-certificate"></i>
                                                            Generate Certificate
                                                        </a>
                                                        <a class="badge badge-danger" href="pages_ins_manage_certificates.php?delete_cert=<?php echo $row->cert_id; ?>">
