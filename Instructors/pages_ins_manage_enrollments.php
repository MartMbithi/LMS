                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-warning" 
                                                         href="pages_ins_update_single_enrollment.php?en_id=<?php echo $row->en_id;?>&cc_id=<?php echo $row->cc_id;?>&c_id=<?php echo $row->c_id;?>&s_id=<?php echo $row->s_id;?>&s_course=<?php echo $row->s_course;?>">
                                                         <i class="fas fa-edit"></i> <i class=" fas fa-pallet"></i>
                                                             Update
                                                    </a>
                                                    <a class="badge badge-danger" 
                                                         href="pages_ins_manage_enrollments.php?delete_en_id=<?php echo $row->en_id;?>">
