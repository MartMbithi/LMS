...
<body onload=display_ct();>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <div class="container-fluid" id="print_questions">
                <div class="row">
                ...
                <hr>
                <button id="print" onclick='printContent("Print");' class = "btn btn-outline-success"><i class="fas fa-print"></i>Print Questions</button>
