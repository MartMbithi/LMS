<aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="pages_std_dashboard.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon icon-user-following"></i><span
                                    class="hide-menu">My Profile</span></a>

                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="pages_std_view_profile.php" class="sidebar-link"><span
                                            class="hide-menu"> View
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_std_profile.php" class="sidebar-link"><span
                                            class="hide-menu"> Update
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_std_pwd_change.php" class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon icon-note"></i><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon  icon-check "></i><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="pages_std_pay_study_materials.php" class="sidebar-link"><span
                                            class="hide-menu"> Pay 
                                        </span></a>
                                </li>
                                

                                <li class="sidebar-item"><a href="pages_std_view_payments.php" class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="pages_std_view_results.php" class="sidebar-link"><span
                                            class="hide-menu">View</span></a>
                                </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon   icon-trophy  "></i><span
                                    class="hide-menu">Certificates</span></a>

                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                
                                <li class="sidebar-item"><a href="pages_std_view_certificates.php" class="sidebar-link"><span
                                            class="hide-menu"> View </span></a>
                                </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="pages_std_logout.php"
