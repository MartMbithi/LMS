...
instructor();
require_once('../partials/ins_analytics.php');
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="info-box mb-3">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Allocated Units</span>
                                        <span class="info-box-number"><?php echo $allocated_units; ?></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="dash-1" class="table table-striped table-bordered display" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $ret = "SELECT  * FROM  lms_enrollments WHERE i_id = '$i_id' ";
                                                $stmt = $mysqli->prepare($ret);
                                                $stmt->execute(); //ok
                                                $res = $stmt->get_result();
                                                while ($row = $res->fetch_object()) {
