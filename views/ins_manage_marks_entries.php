...
if (isset($_POST['update_marks'])) {
    ...
    if (!$error) {
        ...
        $stmt->execute();
        if ($stmt) {
            $success = "Updated" && header("refresh:1; url=ins_manage_marks_entries.php");
        } else {
...
if (isset($_GET['delete'])) {
    ...
    $stmt->close();
    if ($stmt) {
        $success = "Deleted" && header("refresh:1; url=ins_manage_marks_entries.php");
    } else {
        $info = "Please Try Again Or Try Later";
    }
}
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="ins_dashboard.php">Marks Entries</a></li>
                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a href="ins_marks.php" class="btn btn-outline-warning">Add Marks Entries</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <table id="dash-2" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $id = $_SESSION['i_id'];
                                            $ret = "SELECT  * FROM  lms_results WHERE i_id = '$id' ";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->execute(); //ok
                                            $res = $stmt->get_result();
                                            while ($results = $res->fetch_object()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-warning" href="ins_view_marks_entry.php?view=<?php echo $results->rs_id; ?>">
