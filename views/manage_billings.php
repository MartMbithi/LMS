            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Intergrated LMS - Payment Records</h1>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="text-right text-dark">
                                <a class="btn btn-warning" href="billings.php">Add Study Materials Payments</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                            ...
                                            while ($payments = $res->fetch_object()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class='badge badge-warning' href='view_payment.php?view=<?php echo $payments->psm_id; ?>'>
