...
if (isset($_POST['update_studymaterial'])) {
    ...
    if (!$error) {
        ...
        $stmt->execute();
        if ($stmt) {
            $success = "Added" && header("refresh:1; url=.php");
        } else {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Intergrated LMS - Study Materials</h1>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                                    ...
                                                                    <form method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                ...
                                                                                <input type="text" name="sm_number" value="<?php echo $a; ?>-<?php echo $b; ?>" required class="form-control">
                                                    ...
                                                    <!-- End Modal -->
                                                    <a class="badge badge-warning" data-toggle="modal" href="#add-<?php echo $study_materials->ua_id; ?>">
