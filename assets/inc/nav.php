                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="top-contact">
                            ...
                            <div class="contacts">
                                <span><i class="fas fa-phone"></i> <a href="tel:0705 593 4570">(+254) 705 593 4570</a></span>
                                <span><i class="fas fa-envelope"></i> <a href="mailto:support@lms.com">support@lms.com</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="menu-search-form dropdown float-right">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span>Search Any Courses</span> <i class="fas fa-search"></i>
                            </a>
                            <div class="dropdown-menu">
                                <form action="courses.php" class="menu-search">
