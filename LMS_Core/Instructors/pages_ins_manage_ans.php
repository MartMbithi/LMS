                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display "
                                        ...
                                        <?php
                                            $i_id = $_SESSION['i_id'];
                                            $ret="SELECT  * FROM  lms_answers  WHERE i_id = ? ";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-success" href="pages_ins_update_specific_ans.php?an_id=<?php echo $row->an_id;?>">
                                                     <i class="fas fa-edit"></i> <i class="icon  icon-doc "></i> Update Answers
                                                    </a>
                                                    
                                                    <a class="badge badge-danger" href="pages_ins_manage_ans.php?delete=<?php echo $row->an_id;?>">
