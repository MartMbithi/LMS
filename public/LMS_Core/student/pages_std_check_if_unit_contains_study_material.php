                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_std_pay_study_materials.php">Add</a>
                                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select Unit To Pay For Its Course Study Materials. </h4>
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display " style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $c_id = $_GET['c_id'];
                                            $ret = "SELECT  * FROM  lms_study_material WHERE c_id =? ";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_std_pay_price_single_studymt.php?ls_id=<?php echo $row->ls_id; ?>&c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>&sm_number=<?php echo $row->sm_number; ?>&i_id=<?php echo $row->i_id; ?>">
                                                            <i class="fas fa-money-bill-alt"></i> <i class="icon  icon-check "></i> Pay
                                                        </a>
                                                        <!--
