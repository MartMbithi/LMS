                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-success" 
                                                         href="pages_student_join_forum.php?f_id=<?php echo $row->f_id;?>&i_id=<?php echo $row->i_id;?>&c_id=<?php echo $row->c_id;?>&s_unit_code=<?php echo $row->s_unit_code;?>&s_unit_name=<?php echo $row->s_unit_name;?>&f_no=<?php echo $row->f_no;?>">
