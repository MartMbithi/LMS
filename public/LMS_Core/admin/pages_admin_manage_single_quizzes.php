                            ...
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="pages_admin_manage_testquizzes.php"><?php echo $row->c_name; ?> Questions.</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_admin_update_specific_quizzes.php?q_id=<?php echo $row->q_id; ?>">
