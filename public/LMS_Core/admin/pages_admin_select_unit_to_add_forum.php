                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_admin_select_unit_to_add_forum.php">Forum</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="pages_admin_select_unit_to_add_forum.php">Add Discussion</a>
                                    </li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_admin_forum.php?en_id=<?php echo $row->en_id; ?>&c_id=<?php echo $row->c_id; ?>&i_id=<?php echo $row->i_id; ?>&s_unit_code=<?php echo $row->s_unit_code; ?>&s_unit_name=<?php echo $row->s_unit_name; ?>">
                                                            <i class="far fa-plus-square"></i> <i class=" icon icon-envelope-open"></i>
