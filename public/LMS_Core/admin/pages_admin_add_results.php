                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_admin_add_individual_student_results.php?s_id=<?php echo $row->s_id; ?>&cc_id=<?php echo $row->cc_id; ?>&c_id=<?php echo $row->c_id; ?>&i_id=<?php echo $row->i_id; ?>&en_id=<?php echo $row->en_id; ?>">
