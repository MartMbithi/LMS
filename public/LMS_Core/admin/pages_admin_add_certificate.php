                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="badge badge-success" href="pages_admin_add_single_certificate.php?en_id=<?php echo $row->en_id; ?>&s_id=<?php echo $row->s_id; ?>&i_id=<?php echo $row->i_id; ?>&en_date=<?php echo date("d M Y", strtotime($mysqlDateTime)); ?>">
