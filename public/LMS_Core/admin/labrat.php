...
<head>
    ...
    <style>
        #certificate {
            background: linear-gradient(#c8be75 50%, rgba(255, 255, 255, 0) 0) 0 0, radial-gradient(circle closest-side, #c8be75 50%, rgba(255, 255, 255, 0) 0) 0 0, radial-gradient(circle closest-side, #c8be75 0%, rgba(255, 255, 255, 0) 0) 55px 0 #FFF;
...
<body>
    ...
    <div class="certificate-container" style="background:#f9f9f9">
        <table id="certificate" style="width: 11in;margin: 0 auto;text-align: center;padding: 10px;border-style: groove;border-width: 20px;outline: 5px dotted #000;height: 8.5in;outline-offset: -26px;outline-style: double;border-color: #9d8b00;">
            <tr>
                <td>
                    <h1 style="font-size: 0.6in; margin: 0; color: #000;">Certificate of JSSCWS</h1>
                    <h3 style="margin: 0;font-size: 0.25in;color: black;text-transform: uppercase;font-family: sans-serif;">Reg. by UP Government</h3>
                    <p style="font-size: 0.2in;text-transform: uppercase;color: #494000;">Is hereby granted to :</p>
                </td>
            </tr>
            <tr>
                <td>
