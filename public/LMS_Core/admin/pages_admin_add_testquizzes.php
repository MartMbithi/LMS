            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Assaigned Units </h4>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_admin_add_single_quizzes.php?ua_id=<?php echo $row->ua_id; ?>&c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>&i_id=<?php echo $row->i_id; ?>">
                                                            <i class="fas fa-edit"></i><i class="icon  icon-doc "></i> Add Quizzes
                                                        </a>
