                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_admin_assaign_instructors.php">Add</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select Instructor To Assaign Unit</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-warning" href="pages_admin_assaign_single_inst.php?i_id=<?php echo $row->i_id;?>&i_number=<?php echo $row->i_number;?>&i_name=<?php echo $row->i_name;?>">
                                                     <i class="fas fa-edit"></i><i class="fas fa-user"></i> Assaign Unit
                                                    </a>
