                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_admin_answer_specific_quizzes.php?q_id=<?php echo $row->q_id; ?>&q_code=<?php echo $row->q_code; ?>&cc_id=<?php echo $row->cc_id; ?>&c_id=<?php echo $row->c_id; ?>&c_code=<?php echo $row->c_code; ?>&i_id=<?php echo $row->i_id; ?>">
