...
if (isset($_POST['lms_instructor'])) {
    ...
    $query = "UPDATE  lms_instructor SET i_number = ?, i_name = ?, i_phone = ?, i_email = ? WHERE i_id = ?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssssi', $i_number, $i_name, $i_phone, $i_email, $i_id);
    $stmt->execute();

    if ($stmt) {
        $success = "Instructor Account Updated";
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Update <?php echo $row->i_name; ?> Profile.</h4>
                                    <!--Add Student-->
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="form-group col-md-6" style="display:none">
                                                ...
                                                ?>
                                                <input type="text" name="i_number" value="<?php echo $row->i_number; ?>" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Instructor Full Name</label>
                                                <input type="text" name="i_name" required value="<?php echo $row->i_name; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="i_phone" class="form-control" value="<?php echo $row->i_phone; ?>" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            </div>
                                        ...
                                        <button type="submit" name="lms_instructor" class="btn btn-outline-primary">Update Instructor Profile</button>
                                    </form>
                                </div>
                            </div>
                        </div>
