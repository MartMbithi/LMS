...
if (isset($_GET['delete'])) {
    ...
    $adn = "DELETE FROM lms_answers WHERE an_id = ?";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_admin_manage_ans.php">Manage</a>
                                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Units With Answered Questions. </h4>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_admin_update_specific_ans.php?an_id=<?php echo $row->an_id; ?>">
                                                            <i class="fas fa-edit"></i> <i class="icon  icon-doc "></i> Update Answers
                                                        </a>

                                                        <a class="badge badge-danger" href="pages_admin_manage_ans.php?delete=<?php echo $row->an_id; ?>">
                                                            <i class="fas fa-trash"></i> <i class="icon  icon-doc "></i> Delete Answers
                                                        </a>
