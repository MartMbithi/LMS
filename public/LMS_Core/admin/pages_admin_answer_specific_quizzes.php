...
//answer questions that belong to a certain unit.
if (isset($_POST['ans_quiz'])) {
    $q_code = $_GET['q_code'];
    $cc_id = $_GET['cc_id'];
    $c_id = $_GET['c_id'];
    $c_code = $_GET['c_code'];
                            ...
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="pages_admin_add_ans.php">Add</a>
                                        </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Answer <?php echo $row->c_name; ?> Questions.</h4>
                                <!--Add Student-->
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" name="q_details" class="form-control" id="editor1" aria-describedby="emailHelp"><?php echo $row->q_details; ?></textarea>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" name="ans_details" class="form-control" id="editor2" aria-describedby="emailHelp"></textarea>
                                        </div>
                                    ...
                                    <button type="submit" name="ans_quiz" class="btn btn-outline-primary">Answer Questions.</button>
                                </form>
                            </div>
                        </div>
                    </div>
