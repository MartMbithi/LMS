                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" required="required" name="i_email" id="uname" type="email" placeholder="Enter Your Email">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pwd">Password</label>
                                        <input class="form-control" required="required" name="i_pwd" id="pwd" type="password" placeholder="Enter Your Password">
                                    </div>
                                </div>
