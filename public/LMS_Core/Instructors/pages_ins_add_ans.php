            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Units With Added Questions </h4>
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display "
                                        ...
                                        <?php
                                            $i_id = $_SESSION['i_id'];
                                            $ret="SELECT  * FROM  lms_questions WHERE i_id = ?  ";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-success" href="pages_ins_answer_specific_quizzes.php?q_id=<?php echo $row->q_id;?>&q_code=<?php echo $row->q_code;?>&cc_id=<?php echo $row->cc_id;?>&c_id=<?php echo $row->c_id;?>&c_code=<?php echo$row->c_code;?>&i_id=<?php echo $row->i_id;?>">
                                                     <i class="fas fa-check"></i> <i class="icon  icon-doc "></i> Add Answers
                                                    </a>
                                                    <!--
