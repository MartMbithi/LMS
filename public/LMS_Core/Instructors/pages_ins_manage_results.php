                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-warning" 
                                                         href="pages_ins_update_individual_student_results.php?rs_id=<?php echo $row->rs_id;?>">
                                                         <i class="fas fa-edit"></i> <i class=" fas fa-id-badge"></i>
                                                             Update
                                                    </a>
                                                   
                                                    <a class="badge badge-danger" 
                                                         href="pages_ins_manage_results.php?delete=<?php echo $row->rs_id;?>">
                                                         <i class="fas fa-trash"></i> <i class=" fas fa-id-badge"></i>
                                                             Delete
                                                    </a>

                                                    <a class="badge badge-success" 
                                                         href="pages_ins_view_individual_student_results.php?rs_id=<?php echo $row->rs_id;?>">
