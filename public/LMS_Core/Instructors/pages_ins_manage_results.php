...
if (isset($_GET['delete'])) {
    ...
    $adn = "DELETE FROM lms_results WHERE rs_id = ?";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_ins_manage_results.php">Manage</a>
                                    </li>
                                ...
                                <div class="table-responsive">
                                    <table id="default_order" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $i_id = $_SESSION['i_id'];
                                            $ret = "SELECT  * FROM  lms_results WHERE i_id = ?";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-warning" href="pages_ins_update_individual_student_results.php?rs_id=<?php echo $row->rs_id; ?>">
                                                            <i class="fas fa-edit"></i> <i class=" fas fa-id-badge"></i>
                                                            Update
                                                        </a>

                                                        <a class="badge badge-danger" href="pages_ins_manage_results.php?delete=<?php echo $row->rs_id; ?>">
                                                            <i class="fas fa-trash"></i> <i class=" fas fa-id-badge"></i>
                                                            Delete
                                                        </a>

                                                        <a class="badge badge-success" href="pages_ins_view_individual_student_results.php?rs_id=<?php echo $row->rs_id; ?>">
