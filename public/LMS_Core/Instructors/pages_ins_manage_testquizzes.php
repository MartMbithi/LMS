            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select Any Units To Manage Questions </h4>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-success" href="pages_ins_manage_single_quizzes.php?ua_id=<?php echo $row->ua_id;?>&c_id=<?php echo $row->c_id;?>&cc_id=<?php echo $row->cc_id;?>&i_id=<?php echo $row->i_id;?>">
                                                     <i class="fas fa-cogs"></i><i class="icon  icon-doc "></i> Manage Quizzes
                                                    </a>
