                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_ins_view_testquizzes.php">View</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select Any Units To View Questions </h4>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_ins_view_single_quizzes.php?ua_id=<?php echo $row->ua_id; ?>&c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>&i_id=<?php echo $row->i_id; ?>">
