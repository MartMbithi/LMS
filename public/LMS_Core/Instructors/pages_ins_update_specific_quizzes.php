...
if (isset($_POST['update_quiz'])) {
    ...
    $query = "UPDATE  lms_questions SET  q_details =? WHERE  q_id =?";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('si', $q_details, $q_id);
    $stmt->execute();
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update <?php echo $row->c_name; ?> Questions.</h4>
                                <!--Add Student-->
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" name="update_quiz" class="btn btn-outline-primary">Update Questions.</button>
                                </form>
                            </div>
                        </div>
                    </div>
