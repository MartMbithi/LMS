                                ...
                                <div class="table-responsive">
                                    <table id="multi_col_order" class="table table-striped table-bordered display " style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $i_id = $_SESSION['i_id'];
                                            $ret = "SELECT  * FROM  lms_paid_study_materials WHERE i_id =? ";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="badge badge-success" href="pages_ins_view_single_payment.php?psm_id=<?php echo $row->psm_id; ?>">
                                                            <i class="fas fa-eye "></i> <i class="fas fa-money-bill-alt"></i> View
                                                        </a>
                                                        <!--
