            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">View Instructors</h4>
                                    ...
                                    <table id="multi_col_order" class="table table-striped table-bordered display no-wrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge badge-success" href="pages_admin_view_single_inst.php?i_id=<?php echo $row->i_id;?>&i_number=<?php echo $row->i_number;?>">
                                                     <i class="fas fa-eye"></i><i class="fas fa-user"></i> View 
                                                    </a>
                                                    <a class="badge badge-warning" href="pages_admin_edit_single_inst.php?i_id=<?php echo $row->i_id;?>&i_number=<?php echo $row->i_number;?>">
                                                     <i class="fas fa-edit"></i><i class="fas fa-user"></i> Edit
                                                    </a>
                                                    <a class="badge badge-danger" href="pages_admin_manage_instructors.php?delete_ins=<?php echo $row->i_id;?>">
