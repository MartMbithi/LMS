            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        <?php } ?>
                        <!--Get Details of single Forum Topic-->
                        <?php
                        $f_id = $_GET['f_id'];
                            ...
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="pages_admin_manage_forum.php">Forum</a>
                                        </li>
                                        <li class="breadcrumb-item"><a href="pages_admin_manage_forum.php">Manage Discussion</a>
                                        </li>
