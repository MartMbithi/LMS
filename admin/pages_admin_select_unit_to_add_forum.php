                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="badge badge-success" 
                                                         href="pages_admin_forum.php?en_id=<?php echo $row->en_id;?>&c_id=<?php echo $row->c_id;?>&i_id=<?php echo $row->i_id;?>&s_unit_code=<?php echo $row->s_unit_code;?>&s_unit_name=<?php echo $row->s_unit_name;?>">
