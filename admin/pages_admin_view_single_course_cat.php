            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Course Category Name      : <?php echo $row->cc_name;?></li>
                            <li class="list-group-item">Course Category Code    : <?php echo $row->cc_code;?></li>
                        </ul>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Course Category Description</li>
