    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Messange</li>
                            <?php
                            $id = $_GET['id'];
                            $ret = "SELECT  * FROM  lms_messanges WHERE id = ?";
                            $stmt = $mysqli->prepare($ret);
                            ...
                            ?>
                                <li class="list-group-item"><?php echo $row->subject; ?></li>
                                <li class="list-group-item"><?php echo $row->msg; ?></li>
                ...
                <a tearge="_blank" href="mailto:<?php echo $row->email; ?>" class="btn btn-outline-success"><i class="fas fa-reply"></i> Reply</a>
            <?php } ?>
