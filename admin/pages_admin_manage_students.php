                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="badge badge-warning" href="pages_admin_update_single_student.php?s_id=<?php echo $row->s_id;?>&s_regno=<?php echo $row->s_regno;?>">
                                                    <i class="fas fa-edit"></i><i class="fas fa-user"></i> Update
                                                    </a>
                                                    <a class="badge badge-danger" href="pages_admin_manage_students.php?delete_std=<?php echo $row->s_id;?>">
