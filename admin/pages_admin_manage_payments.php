            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Select A Study Materials Or Course Work To Add Payment. </h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Ksh <?php echo $row->sm_price; ?></td>
                                                    <td>

                                                        <a class="badge badge-success" href="pages_admin_pay_price_single_studymt.php?ls_id=<?php echo $row->ls_id; ?>&c_id=<?php echo $row->c_id; ?>&cc_id=<?php echo $row->cc_id; ?>&i_id=<?php echo $row->i_id; ?>&sm_number=<?php echo $row->sm_number; ?>">
                                                            <i class="fas fa-money-bill-alt"></i> <i class="icon  icon-check "></i> Payment
                                                        </a>
                                                        <!--
