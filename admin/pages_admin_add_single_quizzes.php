<?php
  ...
  //add new questions that belong to a certain unit.
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        <?php
                            $ua_id = $_GET['ua_id'];
                            $ret="SELECT  * FROM  lms_units_assaigns WHERE ua_id = ?";
                            $stmt= $mysqli->prepare($ret) ;
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                 <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_admin_add_testquizzes.php">Add</a>
                                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add <?php echo $row->c_name;?> Questions.</h4>
                                <!--Add Student-->
                                <form method ="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="c_code" readonly value="<?php echo $row->c_code;?>"  required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6" style="display:none">
                                            <label for="exampleInputEmail1">Questions Code</label>
                                                <?php 
                                                    $length = 4;    
                                                    $q_code =  substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1,$length);
                                                ?>
                                            <input type="text" name="q_code" readonly value="QNS-<?php echo $q_code;?>"  required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea type="text" name="q_details"  class="form-control" id="editor1" aria-describedby="emailHelp"></textarea>
                                        </div>
                                   ...
                                   <hr>
                                    ...
                                    <button type="submit" name="add_quiz" class="btn btn-outline-primary">Add Questions.</button>
                                </form>
                            </div>
                        </div>
                    </div>
