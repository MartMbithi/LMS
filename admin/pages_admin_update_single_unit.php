<?php
  ...
  if(isset($_POST['update_unit']))
  {
     ...
     // $i_id = $_SESSION['i_id'];<--Uncommment this if instructror is the one adding the unit. 
      ...
      $query="UPDATE lms_course SET  cc_id = ?, a_id=?, c_code=?, c_name=?, c_category=?, c_desc=? WHERE c_id=?";
      $stmt = $mysqli->prepare($query);
      $rc=$stmt->bind_param('ssssssi', $cc_id, $a_id, $c_code, $c_name, $c_category, $c_desc, $c_id);
      $stmt->execute();
