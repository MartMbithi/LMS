<aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="pages_admin_dashboard.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon icon-user-following"></i><span
                                    class="hide-menu">Instructors</span></a>

                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="pages_admin_add_instructor.php" class="sidebar-link"><span
                                            class="hide-menu"> Register
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_admin_view_instructors.php" class="sidebar-link"><span
                                            class="hide-menu"> View
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_admin_manage_instructors.php" class="sidebar-link"><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon icon-people"></i><span
                                    class="hide-menu">Students</span></a>
                                    
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="pages_admin_add_student.php" class="sidebar-link"><span
                                            class="hide-menu"> Register
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_admin_view_students.php" class="sidebar-link"><span
                                            class="hide-menu"> View
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="pages_admin_manage_students.php" class="sidebar-link"><span
                                            class="hide-menu"> Manage
                                        </span></a>
                                </li>
                            </ul>
