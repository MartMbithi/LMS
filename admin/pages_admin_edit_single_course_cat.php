<?php
  ...
  if(isset($_POST['update_course_cat']))
  {
      ...
      if($stmt)
      {
                $success = "Course Category Updated";
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update <?php echo $row->cc_name;?></h4>
                                <!--Add Student-->
                                <form method ="post" enctype="multipart/form-data">
                                   ...
                                   <hr>
                                    ...
                                    <button type="submit" name="update_course_cat" class="btn btn-outline-primary">Update Course Category</button>
                                </form>
                            </div>
                        </div>
                    </div>
